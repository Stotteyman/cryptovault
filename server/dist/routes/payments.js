 ...
 */
router.post('/payments/vt/purchase', async (req, res) => {
    try {
 ...
 */
router.get('/payments/tiers', async (req, res) => {
    try {
        res.json({
 ...
 */
router.post('/payments/apple/verify', async (req, res) => {
    try {
 ...
 */
router.post('/payments/google/verify', async (req, res) => {
    try {
