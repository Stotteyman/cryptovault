...
export function updateAccountBalance(id, amount) {
...
export function createCharacter(character) {
  ...
  `).run(id, character.name, character.class, character.level || 1, character.health, character.attack, character.defense, character.nameColor || null, character.nameEffect || null, character.nameCost || 0, character.colorCost || 0, character.effectCost || 0, character.classCost || 0, character.ownerId);
    return character;
}
...
export function listCharacterForTrade(characterId, price, seller) {
    db.prepare(`
    UPDATE characters 
...
export function buyCharacter(characterId, buyerWallet, newOwnerId) {
